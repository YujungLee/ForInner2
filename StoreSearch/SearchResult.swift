...
class SearchResult {
    ...
    let events = [
        Entry(title: "아라리오뮤지엄 인 스페이스: Really?", date: "2014.08.01 ~ 2017.07.31", place: "ARARIO MUSEUM IN SPACE", price: 12000, progress: 2.5,
        ...
        Entry(title: "K-pop 홀로그램 콘서트 “케이라이브(K-liv)”", date: "2016.03.01 ~ 2016.12.31", place: "케이라이브(K-live)", price: 33000,  progress: 0.3,
